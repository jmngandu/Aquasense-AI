...
waste_notification_views = db.Table('waste_notification_views',
    ...
    db.Column('waste_notification_id', db.Integer, db.ForeignKey('waste_notification.id_notification'), primary_key=True),
...
water_shortage_notification_views = db.Table('water_shortage_notification_views',
    db.Column('id', db.Integer, autoincrement=True, primary_key=True),
    db.Column('water_shortage_notification_id', db.Integer, db.ForeignKey('water_shortage_notification.id_notification'), primary_key=True),
    db.Column('responsible_id', db.Integer, db.ForeignKey('responsible.id_user'), primary_key=True)
)
